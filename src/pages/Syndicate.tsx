                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="bg-slate-900 border border-slate-800 rounded-lg p-6">
                        ...
                        <select
                            ...
                            className="w-full bg-slate-950 border border-slate-800 rounded-lg px-4 py-3 text-slate-100 font-medium focus:outline-none focus:ring-1 focus:ring-amber-500 transition-all hover:border-slate-700"
                        >
                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-slate-900 border border-slate-800 rounded-lg p-6 relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            <PriceDisplay amount={totalPrice} size="xl" highlight={false} className="text-slate-100" />
                        </div>
                        <div className="mt-4 pt-4 border-t border-slate-800 space-y-2 text-sm relative z-10">
                            <div className="flex justify-between text-slate-500">
                                <span>Preço por jogo:</span>
                                <span className="font-mono text-slate-400">{formatPrice(config.priceTable[numbersCount])}</span>
                            </div>
                            <div className="flex justify-between text-slate-500">
                                <span>Total de jogos:</span>
                                <span className="font-mono text-slate-400">{gamesCount}</span>
                            </div>
                        </div>
                    </div>
